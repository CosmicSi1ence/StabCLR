...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnGoConfirm->Text = L"ќткрыть";
			...
			this->Text = L"”кажите путь к файлу";
...
private: System::Void btnGoConfirm_Click(System::Object^ sender, System::EventArgs^ e) {
	using(FolderBrowserDialog fdb = new FolderBrowserDialog(){ Description = "”кажите путь" }) {
